...
| S-06 | 근무 설정 | `/settings/work` | 선택형 정시 출근/퇴근, 연장/야간 시작, 휴게시간, 평일 요일, 포함 시간 비교 설정 | `WorkRule`, `CompensationReferenceSetting` |
...
| 설정 | 근무 설정 | `근무 설정` 항목. 정시 출퇴근, 연장/야간 시작, 휴게시간, 근무 요일, 포함 시간 비교를 설정 |
| 설정 | 총 연차 설정 | `총 연차` 항목 |
| 설정 | 알림 설정 | `알림` 항목 |
